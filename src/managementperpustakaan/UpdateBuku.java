...
public class UpdateBuku extends javax.swing.JFrame {
    ...
    Connection conn;
     public UpdateBuku(String kodeBuku, String judul, String penulis, String penerbit, 
                  String tahunTerbit, String kategori, int stok) {
    initComponents();
    connection();
    txt_kodeBuku.setText(kodeBuku);
...
private Connection connection() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(btn_update, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
    ...
    try {
        ...
        String sql = "UPDATE buku SET judul = ?, penerbit = ?, penulis = ?, tahun_terbit = ?, kategori = ?, stok = ? WHERE kode_buku = ?";
